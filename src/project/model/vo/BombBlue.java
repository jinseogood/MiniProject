...
public class BombBlue extends Item implements Runnable{
	...
	public BombBlue(){}
	public BombBlue(JPanel panel, HumanMove human){
		this.panel=panel;
		this.human=human;
		this.makeItem();
	}
	...
	public void makeItem(){
		...
		Image itemImg=new ImageIcon("images/bombBlue.gif").getImage().getScaledInstance(50, 50, 0);
