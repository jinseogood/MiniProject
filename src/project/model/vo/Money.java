...
public class Money extends Item implements Runnable{
	...
	public Money(){}
	public Money(JPanel panel, HumanMove human){
		this.panel=panel;
		this.human=human;
		this.makeItem();
	}
	...
	public void makeItem(){
		...
		Image itemImg=new ImageIcon("images/money.gif").getImage().getScaledInstance(50, 50, 0);
		...
		try {
			...
			while(true){
				if(itemY<407){
					...
					if(dis<50 && itemY > 330){
						human.setScore(human.getScore()+5000);
						this.fallingEnd();
						break;
					}
					Thread.sleep(100);
