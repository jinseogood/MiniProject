...
public class Moneybag extends Item implements Runnable{
	...
	public Moneybag(){}
	public Moneybag(JPanel panel, HumanMove human){
		this.panel=panel;
		this.human=human;
		this.makeItem();
	}
	...
	public void makeItem(){
		...
		Image itemImg=new ImageIcon("images/moneybag.gif").getImage().getScaledInstance(50, 50, 0);
